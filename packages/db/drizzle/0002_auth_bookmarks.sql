...
ALTER TABLE "app_user" ADD COLUMN "updated_at" timestamp with time zone DEFAULT now() NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "bookmark_user_verse_idx" ON "bookmark" USING btree ("user_id","verse_id");